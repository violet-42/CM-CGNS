...
class ResNet(nn.Module):
    def __init__(self, in_channels=1, name=None, pool_method='mean', pretrained=True) -> None:  # mgca时改为3通道
        super().__init__()
        self.name = name
        if name == 'resnet_50':
...
if __name__ == '__main__':
    model = ResNet(name='resnet_50', in_channels=1, pretrained=True, pool_method='attention')
