import sys
import glob
sys.path.append('/home/project/clu_mul')
import os
import datetime
...
from mgca.models.backbones.encoder import ImageEncoder, BertEncoder 
...
class CENSJL(LightningModule):
    ...
    def __init__(self, img_encoder='vit_base', stage1_epochs=10, stage2_epochs=10, stage1_warmup_epochs=1,
        ...
        # path = "/home/project/PRIOR-main/codes/prior/encoders/language/Bio_ClinicalBERT"
