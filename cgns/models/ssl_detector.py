...
from cgns.utils.yolo_loss import YOLOLoss
from cgns.datasets.data_module import DataModule
from cgns.datasets.transforms import DataTransforms
from cgns.datasets.detection_dataset import RSNADetectionDataset
from torchmetrics.detection.mean_ap import MeanAveragePrecision
from cgns.utils.detection_utils import non_max_suppression
...
class ModelMain(nn.Module):
    def __init__(self, backbone, is_training=True):
        ...
        #  embedding1  1280->256->512->...->18
        final_out_filter1 = len(self.anchors[1]) * (5 + self.classes)
        self.embedding1_cbl = self._make_cbl(512, 256, 1)  # 一个卷积层
