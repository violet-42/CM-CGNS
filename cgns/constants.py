...
DATA_BASE_DIR = '/home1/Data/'
DATA_BASE_DIR = Path(DATA_BASE_DIR)

DATA_BASE_DIR1 = '/home/***/datasets/'
DATA_BASE_DIR1 = Path(DATA_BASE_DIR1)
# #############################################
# CheXpert constants
# #############################################
...
# #############################################
MIMIC_CXR_DATA_DIR = DATA_BASE_DIR / "MIMIC-CXR-JPJ/mimic-cxr-jpg_2.0.0/"
MIMIC_CXR_REPORT_DIR = DATA_BASE_DIR / "MIMIC-CXR-JPJ/mimic-cxr-reports/"
...
MIMIC_CXR_TEXT_CSV = MIMIC_CXR_DATA_DIR / "MGCA"/"mimic_cxr_sectioned.csv"
MIMIC_CXR_SPLIT_CSV = MIMIC_CXR_DATA_DIR / "mimic-cxr-2.0.0-split.csv"
# Created csv
MIMIC_CXR_TRAIN_CSV = MIMIC_CXR_DATA_DIR / "MGCA/train.csv"
MIMIC_CXR_VALID_CSV = MIMIC_CXR_DATA_DIR / "MGCA/test.csv"
MIMIC_CXR_TEST_CSV = MIMIC_CXR_DATA_DIR / "MGCA/test.csv"
MIMIC_CXR_MASTER_CSV = MIMIC_CXR_DATA_DIR / "MGCA/master.csv"
...
# RSNA constants
# #############################################
RSNA_DATA_DIR = DATA_BASE_DIR1 / "RSNA_Pneumonia"
...
# SIIM constants
# #############################################
PNEUMOTHORAX_DATA_DIR = DATA_BASE_DIR1 / "SIIM_Pneumothorax"
...
# #############################################
COVIDX_DATA_DIR = DATA_BASE_DIR1 / "COVIDx"
...
# COVIDx constants
# #############################################
TUBERCULOSIS_DATA_DIR = DATA_BASE_DIR1 / "tuberculosis"
...
# #############################################
VIN_DATA_DIR = DATA_BASE_DIR1 / "vinbigdata"
...
# #############################################
OBJ_DATA_DIR = DATA_BASE_DIR1 / "object-CXR"
